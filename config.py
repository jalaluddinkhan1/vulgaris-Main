"""Standalone configuration dataclasses for VULGARIS.

This module has NO dependencies on other VULGARIS modules so it can be
imported early without triggering circular imports.
"""
